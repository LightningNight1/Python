...
Второй вариант задачи сделал через оператора возведения в степень "**", по времени получилось 0.4285149999996065
Благодаря решению через оператора "**" удалось ускориться на ~ 70%
'''
